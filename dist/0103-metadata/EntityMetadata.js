...
const CannotCreateEntityIdMapError_1 = require("../0402-error/CannotCreateEntityIdMapError");
...
class EntityMetadata {
    ...
    static difference(firstIdMaps, secondIdMaps) {
        return firstIdMaps.filter(firstIdMap => {
            return !secondIdMaps.find(secondIdMap => OrmUtils_1.OrmUtils.deepCompare(firstIdMap, secondIdMap));
        });
    }
    /**
