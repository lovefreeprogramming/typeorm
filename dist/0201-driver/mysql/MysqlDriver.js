...
const ConnectionIsNotSetError_1 = require("../../0402-error/ConnectionIsNotSetError");
const DriverPackageNotInstalledError_1 = require("../../0402-error/DriverPackageNotInstalledError");
...
class MysqlDriver {
    ...
    createConnectionOptions(options, credentials) {
        ...
        return Object.assign({}, {
            ...
            ssl: options.ssl
        }, options.acquireTimeout === undefined ? {} : { acquireTimeout: options.acquireTimeout }, options.extra || {});
    }
    /**
     * Creates a new connection pool for a given database credentials.
     */
