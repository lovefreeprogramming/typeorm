...
const AuroraDataApiQueryRunner_1 = require("./AuroraDataApiQueryRunner");
const DateUtils_1 = require("../../util/DateUtils");
const PlatformTools_1 = require("../../platform/PlatformTools");
const RdbmsSchemaBuilder_1 = require("../../0107-schema-builder/RdbmsSchemaBuilder");
...
class AuroraDataApiDriver {
    ...
    constructor(connection) {
        ...
        this.client = new this.DataApiDriver(this.options.region, this.options.secretArn, this.options.resourceArn, this.options.database, (query, parameters) => this.connection.logger.logQuery(query, parameters));
