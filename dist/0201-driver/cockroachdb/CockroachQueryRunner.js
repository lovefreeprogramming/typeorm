...
const TableCheck_1 = require("../../0107-schema-builder/table/TableCheck");
const TableExclusion_1 = require("../../0107-schema-builder/table/TableExclusion");
/**
...
class CockroachQueryRunner extends BaseQueryRunner_1.BaseQueryRunner {
    ...
    async commitTransaction() {
        ...
        try {
            ...
            if (e.code === "40001") {
                ...
                await index_1.PromiseUtils.runInSequence(this.queries, q => this.query(q.query, q.parameters));
    ...
    async createTable(table, ifNotExist = false, createForeignKeys = true, createIndices = true) {
        ...
        table.columns
            ...
            .forEach(column => {
            upQueries.push(new Query_1.Query(`CREATE SEQUENCE ${this.buildSequenceName(table, column)}`));
            downQueries.push(new Query_1.Query(`DROP SEQUENCE ${this.buildSequenceName(table, column)}`));
        });
    ...
    async createUniqueConstraints(tableOrName, uniqueConstraints) {
        await index_1.PromiseUtils.runInSequence(uniqueConstraints, uniqueConstraint => this.createUniqueConstraint(tableOrName, uniqueConstraint));
    }
    /**
    ...
    async dropUniqueConstraints(tableOrName, uniqueConstraints) {
        await index_1.PromiseUtils.runInSequence(uniqueConstraints, uniqueConstraint => this.dropUniqueConstraint(tableOrName, uniqueConstraint));
    }
    /**
    ...
    async createForeignKeys(tableOrName, foreignKeys) {
        await index_1.PromiseUtils.runInSequence(foreignKeys, foreignKey => this.createForeignKey(tableOrName, foreignKey));
    }
    /**
    ...
    async dropForeignKeys(tableOrName, foreignKeys) {
        await index_1.PromiseUtils.runInSequence(foreignKeys, foreignKey => this.dropForeignKey(tableOrName, foreignKey));
    }
    /**
     * Creates a new index.
     */
    ...
    async createIndices(tableOrName, indices) {
        await index_1.PromiseUtils.runInSequence(indices, index => this.createIndex(tableOrName, index));
    }
    /**
    ...
    async dropIndices(tableOrName, indices) {
        await index_1.PromiseUtils.runInSequence(indices, index => this.dropIndex(tableOrName, index));
    }
    /**
    ...
    dropIndexSql(table, indexOrName) {
        let indexName = (indexOrName instanceof TableIndex_1.TableIndex || indexOrName instanceof TableUnique_1.TableUnique) ? indexOrName.name : indexOrName;
