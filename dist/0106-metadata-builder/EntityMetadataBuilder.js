...
const ColumnMetadata_1 = require("../0103-metadata/ColumnMetadata");
const IndexMetadata_1 = require("../0103-metadata/IndexMetadata");
const RelationMetadata_1 = require("../0103-metadata/RelationMetadata");
const EmbeddedMetadata_1 = require("../0103-metadata/EmbeddedMetadata");
const RelationIdMetadata_1 = require("../0103-metadata/RelationIdMetadata");
const RelationCountMetadata_1 = require("../0103-metadata/RelationCountMetadata");
...
const EntityListenerMetadata_1 = require("../0103-metadata/EntityListenerMetadata");
const UniqueMetadata_1 = require("../0103-metadata/UniqueMetadata");
const MysqlDriver_1 = require("../0201-driver/mysql/MysqlDriver");
const CheckMetadata_1 = require("../0103-metadata/CheckMetadata");
...
const ExclusionMetadata_1 = require("../0103-metadata/ExclusionMetadata");
...
class EntityMetadataBuilder {
            ...
            entityMetadata.relations.filter(relation => relation.isOneToOne || relation.isManyToOne).forEach(relation => {
                ...
                if (uniqueConstraint) {
                    if (this.connection.driver instanceof MysqlDriver_1.MysqlDriver || this.connection.driver instanceof AuroraDataApiDriver_1.AuroraDataApiDriver
                        || this.connection.driver instanceof SqlServerDriver_1.SqlServerDriver || this.connection.driver instanceof SapDriver_1.SapDriver) {
                ...
                if (foreignKey && this.connection.driver instanceof CockroachDriver_1.CockroachDriver) {
                    const index = new IndexMetadata_1.IndexMetadata({
    ...
    computeEntityMetadataStep1(allEntityMetadatas, entityMetadata) {
        ...
        entityMetadata.ownColumns = this.metadataArgsStorage
            ...
            const column = new ColumnMetadata_1.ColumnMetadata({ connection: this.connection, entityMetadata, args });
    ...
    createEmbeddedsRecursively(entityMetadata, embeddedArgs) {
        return embeddedArgs.map(embeddedArgs => {
            ...
            const targets = MetadataUtils_1.MetadataUtils.getInheritanceTree(embeddedMetadata.type);
            embeddedMetadata.columns = this.metadataArgsStorage.filterColumns(targets).map(args => {
                return new ColumnMetadata_1.ColumnMetadata({ connection: this.connection, entityMetadata, embeddedMetadata, args });
            });
            ...
            embeddedMetadata.indices = this.metadataArgsStorage.filterIndices(targets).map(args => {
                return new IndexMetadata_1.IndexMetadata({ entityMetadata, embeddedMetadata, args });
            });
            embeddedMetadata.uniques = this.metadataArgsStorage.filterUniques(targets).map(args => {
                return new UniqueMetadata_1.UniqueMetadata({ entityMetadata, embeddedMetadata, args });
            });
