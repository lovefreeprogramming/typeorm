...
class RelationIdLoader {
    ...
    async loadManyToManyRelationIdsAndGroup(relation, entitiesOrEntities, relatedEntityOrEntities) {
        ...
        const entities = entitiesOrEntities instanceof Array ? entitiesOrEntities : [entitiesOrEntities];
        ...
        const relatedEntities = relatedEntityOrEntities instanceof Array ? relatedEntityOrEntities : [relatedEntityOrEntities];
