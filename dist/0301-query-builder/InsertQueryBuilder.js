...
const InsertValuesMissingError_1 = require("../0402-error/InsertValuesMissingError");
            ...
            valueSets.forEach((valueSet, valueSetIndex) => {
                columns.forEach((column, columnIndex) => {
                    ...
                    if (column.isVersion) {
                        ...
                        if (this.connection.driver instanceof AbstractSqliteDriver_1.AbstractSqliteDriver || this.connection.driver instanceof SapDriver_1.SapDriver) { // unfortunately sqlite does not support DEFAULT expression in INSERT queries
