...
const FindOperator_1 = require("../0302-find-options/FindOperator");
const In_1 = require("../0302-find-options/operator/In");
...
class QueryBuilder {
    ...
    update(entityOrTableNameUpdateSet, maybeUpdateSet) {
        ...
        entityOrTableNameUpdateSet = entityOrTableNameUpdateSet instanceof index_1.EntitySchema ? entityOrTableNameUpdateSet.options.name : entityOrTableNameUpdateSet;
