...
class ReturningResultsEntityUpdator {
    ...
    async insert(insertResult, entities) {
        ...
        const generatedMaps = entities.map((entity, entityIndex) => {
            if (this.queryRunner.connection.driver instanceof OracleDriver_1.OracleDriver && insertResult.raw instanceof Array && this.expressionMap.extraReturningColumns.length > 0) {
