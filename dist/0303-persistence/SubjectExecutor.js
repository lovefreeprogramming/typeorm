...
const SubjectWithoutIdentifierError_1 = require("../0402-error/SubjectWithoutIdentifierError");
const SubjectRemovedAndUpdatedError_1 = require("../0402-error/SubjectRemovedAndUpdatedError");
const MongoQueryRunner_1 = require("../0201-driver/mongodb/MongoQueryRunner");
...
class SubjectExecutor {
    ...
    async executeInsertOperations() {
        ...
        await PromiseUtils_1.PromiseUtils.runInSequence(groupedInsertSubjectKeys, async (groupName) => {
            ...
            if (this.queryRunner instanceof MongoQueryRunner_1.MongoQueryRunner) {
                ...
                if (singleInsertSubjects.length > 0) {
                    await PromiseUtils_1.PromiseUtils.runInSequence(singleInsertSubjects, async (subject) => {
    ...
    async executeRemoveOperations() {
        ...
        await PromiseUtils_1.PromiseUtils.runInSequence(groupedRemoveSubjectKeys, async (groupName) => {
