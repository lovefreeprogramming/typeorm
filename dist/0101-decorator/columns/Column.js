...
const ColumnTypeUndefinedError_1 = require("../../0402-error/ColumnTypeUndefinedError");
/**
...
function Column(typeOrOptions, options) {
    return function (object, propertyName) {
        ...
        if (typeOrOptions instanceof Function) { // register an embedded
            index_1.getMetadataArgsStorage().embeddeds.push({
            ...
            if (options.unique === true)
                index_1.getMetadataArgsStorage().uniques.push({ target: object.constructor, columns: [propertyName] });
            ...
            if (options.generated) {
                index_1.getMetadataArgsStorage().generations.push({
                    target: object.constructor,
                    propertyName: propertyName,
