...
const Query_1 = require("../0201-driver/Query");
const SqlInMemory_1 = require("../0201-driver/SqlInMemory");
...
class BaseQueryRunner {
    ...
    async executeMemoryUpSql() {
        await PromiseUtils_1.PromiseUtils.runInSequence(this.sqlInMemory.upQueries, upQuery => this.query(upQuery.query, upQuery.parameters));
    }
    /**
     * Executes down sql queries.
     */
    async executeMemoryDownSql() {
        await PromiseUtils_1.PromiseUtils.runInSequence(this.sqlInMemory.downQueries.reverse(), downQuery => this.query(downQuery.query, downQuery.parameters));
    }
    // -------------------------------------------------------------------------
    // Protected Methods
    // -------------------------------------------------------------------------
    ...
    async executeQueries(upQueries, downQueries) {
        ...
        await PromiseUtils_1.PromiseUtils.runInSequence(upQueries, upQuery => this.query(upQuery.query, upQuery.parameters));
    }
